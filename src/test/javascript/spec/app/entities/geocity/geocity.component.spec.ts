...
import { GeocityComponent } from 'app/entities/geocity/geocity.component';
import { GeocityService } from 'app/entities/geocity/geocity.service';
import { Geocity } from 'app/shared/model/geocity.model';

describe('Component Tests', () => {
  describe('Geocity Management Component', () => {
    let comp: GeocityComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GeocityComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.geocities[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
